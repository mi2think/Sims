/********************************************************************
	created:	2016/09/04
	created:	4:9:2016   23:40
	filename: 	D:\Code\Sims\Sims\core\key_event.h
...
namespace sims
{
	...
	class KeyPressEvent : public BaseEvent<Event::KEY_PRESS>
	{
	public:
		...
		{
			return str_format("KeyPressEvent:(Key = 0x%x)", key_);
		}
	...
	class KeyReleaseEvent : public BaseEvent<Event::KEY_RELEASE>
	{
	public:
		...
		string ToString() const
		{
			return str_format("KeyReleaseEvent:(Key = 0x%x)", key_);
		}
